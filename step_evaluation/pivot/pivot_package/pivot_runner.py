...
import time
import cv2
import pivot_package.pivot as pivot
...
def pivot_perform_selection(prompter, vlm, im, desc, arm_coord, samples, top_n):
    ...
    # save_image(image_circles_np,f'test_{time_now}.png')
    ...
    response,prompt_tokens,completion_tokens = vlm.query(prompt_seq)
    ...
    try:
        ...
        print(e)
        arrow_ids = []
    return arrow_ids, image_circles_np, prompt_tokens, completion_tokens
...
def pivot_runner(
    ...
    for i in range(n_parallel_trials):
        ...
        for itr in range(n_iters):
            ...
            arrow_ids, image_circles_np,prompt_tokens,completion_tokens = pivot_perform_selection(
            ...
            if itr == n_iters - 1:
                ...
                arrow_ids, _ , prompt_tokens,completion_tokens = pivot_perform_selection(
    ...
    # print(f"GPT_finalchoose:",selected_samples[0].label)
    xy_list = list(xy_tuple)
    return xy_list,prompt_tokens_sum,completion_tokens_sum
